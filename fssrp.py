...
class BaseFSSRPEnsemble(base.Wrapper, base.Ensemble):
    ...
    def __init__(
        ...
        self._base_learner_class: BaseFSSRPClassifier | BaseSRPRegressor | None = None
...
class BaseFSSRPEstimator:
    ...
    def __init__(
        ...
        # Background learner
        self._background_learner: BaseFSSRPClassifier | BaseSRPRegressor | None = None
...
class FSSRPClassifier(BaseFSSRPEnsemble, base.Classifier):
    ...
    def _select_features(self) -> list:
        ...
        alt_feature_sets = get_alternative_features_classification(data=self._fs_samples_x,
...
class BaseFSSRPClassifier(BaseFSSRPEstimator):
    """Class representing the base learner of FSSRPClassifier."""
...
# class SRPRegressor(BaseFSSRPEnsemble, base.Regressor):
...
class BaseSRPRegressor(BaseFSSRPEstimator):
    """Class representing the base learner of FSSRPClassifier."""
